...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sqlUpdate = "UPDATE pengeluaran SET 
                tanggal='$tanggal',
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="kategori" required>
                            <option value="Bahan Baku" <?= ($data['kategori'] == 'Bahan Baku' ? 'selected' : ''); ?>>Bahan
                                Baku
                            </option>
                            <option value="Operasional" <?= ($data['kategori'] == 'Operasional' ? 'selected' : ''); ?>>
                                Operasional</option>
                            <option value="Transportasi" <?= ($data['kategori'] == 'Transportasi' ? 'selected' : ''); ?>>
                                Transportasi</option>
