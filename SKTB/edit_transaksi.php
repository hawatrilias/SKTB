            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="kategori" required>
                        <option value="Pipe Cleaner" <?= $data['kategori'] == 'Pipe Cleaner' ? 'selected' : ''; ?>>Pipe Cleaner</option>
                        <option value="Fresh Flower" <?= $data['kategori'] == 'Fresh Flower' ? 'selected' : ''; ?>>Fresh Flower</option>
                        <option value="Fake Flower" <?= $data['kategori'] == 'Fake Flower' ? 'selected' : ''; ?>>Fake Flower</option>
