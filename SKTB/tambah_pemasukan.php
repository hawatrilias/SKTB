...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO pemasukan (tanggal, keterangan, nominal, sumber) 
            VALUES ('$tanggal', '$keterangan', '$nominal', '$sumber' )";
...
<head>
    ...
    <title>Tambah Pemasukan - Floristy Muse</title>
            ...
            <div class="form-container">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keterangan" placeholder="Contoh: Penjualan bunga" required>
                    </div>
                    <div class="form-group">
                        <label>Jumlah (Rp)</label>
                        <input type="number" name="nominal" placeholder="Contoh: 1000000" required>
                    </div>
                    <div class="form-group">
                        <label>Sumber</label>
                        <input type="text" name="sumber" placeholder="Contoh: Customer / Shopee / Tokopedia">
                    </div>
